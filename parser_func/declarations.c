...
void declare_var(char *id) {
    ...
    symbol_table_add(s_table, id, a_info, 1, SYMBOL_NO_HIDDEN | SYMBOL_IS_CONSTANT);
}
...
void declare_array(char *id, int64_t start_idx, int64_t end_idx) {
    ...
    symbol_table_add(s_table, id, a_info, end_idx - start_idx + 1, SYMBOL_IS_ARRAY | SYMBOL_NO_HIDDEN | SYMBOL_IS_CONSTANT);
}
